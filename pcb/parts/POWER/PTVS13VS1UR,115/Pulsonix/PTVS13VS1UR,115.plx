...
//766732/1781602/2.50/2/2/Diode ESD Uni-directional
...
(library Library_1
	...
	(patternDef "SOD123W" (originalName "SOD123W")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -0.254, -0.01) (textStyleRef "Normal") (isVisible True))
		)
	...
	(symbolDef "PTVS13VS1UR_115" (originalName "PTVS13VS1UR_115")
	...
	(compDef "PTVS13VS1UR,115" (originalName "PTVS13VS1UR,115") (compHeader (numPins 2) (numParts 1) (refDesPrefix D)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "PTVS13VS1UR_115"))
		...
		(attr "Mouser Part Number" "771-PTVS13VS1UR115")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Nexperia/PTVS13VS1UR115?qs=LMSg3oBIm%2FhUJXxROXWM%252Bg%3D%3D")
		(attr "Manufacturer_Name" "Nexperia")
		(attr "Manufacturer_Part_Number" "PTVS13VS1UR,115")
		(attr "Description" "PTVSxS1UR series - 400 W Transient Voltage Suppressor")
		(attr "<Hyperlink>" "https://assets.nexperia.com/documents/data-sheet/PTVSXS1UR_SER.pdf")
		(attr "<STEP Filename>" "PTVS13VS1UR,115.stp")
		(attr "<STEP Offsets>" "X=-1.36;Y=1.97;Z=-1.23")
