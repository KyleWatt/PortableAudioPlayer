...
//184526/1781602/2.50/3/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "2N7002K-T1-E3" (originalName "2N7002K-T1-E3")
	...
	(compDef "2N7002K-T1-E3" (originalName "2N7002K-T1-E3") (compHeader (numPins 3) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "2N7002K-T1-E3"))
		...
		(attr "Mouser Part Number" "781-2N7002K-E3")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Vishay-Siliconix/2N7002K-T1-E3?qs=jcx%252B0HVgj2auuEZ99jRcGQ%3D%3D")
		(attr "Manufacturer_Name" "Vishay")
		(attr "Manufacturer_Part_Number" "2N7002K-T1-E3")
		(attr "Description" "2N7002K-T1-E3, N-channel MOSFET Transistor 0.3 A 60 V, 3-Pin SOT-23, TO-236")
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/Datasheets-DGA23/1579398.pdf")
		(attr "<Component Height>" "1.12")
		(attr "<STEP Filename>" "2N7002K-T1-E3.stp")
