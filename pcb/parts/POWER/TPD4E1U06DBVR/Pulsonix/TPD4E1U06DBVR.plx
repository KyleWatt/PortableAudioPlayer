...
//305163/1781602/2.50/6/3/Integrated Circuit
...
(library Library_1
	...
	(compDef "TPD4E1U06DBVR" (originalName "TPD4E1U06DBVR") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "D1+") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "4" (pinName "D2-") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.ti.com/lit/ds/symlink/tpd4e1u06.pdf")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "TPD4E1U06DBVR.stp")
