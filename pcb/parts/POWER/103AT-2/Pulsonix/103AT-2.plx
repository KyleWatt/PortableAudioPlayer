...
(library Library_1
	...
	(patternDef "103AT2" (originalName "103AT2")
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.2 3.12) (pt 1.2 3.12) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.2 3.12) (pt 1.2 -0.58) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.2 -0.58) (pt -1.2 -0.58) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.2 -0.58) (pt -1.2 3.12) (width 0.025))
		)
	...
	(compDef "103AT-2" (originalName "103AT-2") (compHeader (numPins 2) (numParts 1) (refDesPrefix RT)
		...
		(attr "<Hyperlink>" "https://www.semitec-global.com/uploads/2022/01/P12-13-AT-Thermistor.pdf")
		(attr "<Component Height>" "9.5")
		(attr "<STEP Filename>" "103AT-2.stp")
		(attr "<STEP Offsets>" "X=0;Y=1.27;Z=4.44")
