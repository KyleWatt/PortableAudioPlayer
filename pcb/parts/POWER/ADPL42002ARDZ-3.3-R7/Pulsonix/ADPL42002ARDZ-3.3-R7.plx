...
(library Library_1
	...
	(symbolDef "ADPL42002ARDZ-3.3-R7" (originalName "ADPL42002ARDZ-3.3-R7")
		...
		(pin (pinNum 5) (pt 700 mils -800 mils) (rotation 90) (pinLength 200 mils) (pinDisplay (dispPinName true)) (pinName (text (pt 725 mils -570 mils) (rotation 90]) (justify "Left") (textStyleRef "Normal"))
		))
	...
	(compDef "ADPL42002ARDZ-3.3-R7" (originalName "ADPL42002ARDZ-3.3-R7") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(compPin "3" (pinName "SENSE") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ADPL42002ARDZ-3.3-R7"))
		...
		(attr "<Hyperlink>" "https://www.analog.com/media/en/technical-documentation/data-sheets/adpl42002.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "ADPL42002ARDZ-3.3-R7.stp")
